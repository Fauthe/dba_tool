...
require.cache[require.resolve("~/theme/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("~/theme/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("~/theme/lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["~/theme/lib/codemirror"], mod); }
